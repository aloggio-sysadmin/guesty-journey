...
export default async function renderSmeDetail(container, params) {
  ...
  try {
    ...
    container.innerHTML = `<div class="page-header"><h2><a href="#/sme" style="color:var(--text-secondary)">SMEs</a> / ${data.full_name}</h2>
      ...
      <a href="#/chat/new?sme_id=${data.sme_id}" class="btn btn-primary">+ New Session</a></div></div>
    <div class="page-body">
      <div class="card" style="margin-bottom:16px">
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px">
          ...
          <div><strong>Status</strong><div><span class="badge badge-blue">${data.interview_status}</span></div></div>
